    ...
    <head>
        ...
        <title>Quản Lý Khách Hàng - Đoàn Xuân</title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="content-body">
                <table>
                    <thead>
                        <tr><th>ID</th><th>Tên</th><th>Số Điện Thoại</th><th>Địa Chỉ</th><th>Số Vé</th></tr>
                    </thead>
                    <tbody>
                        <?php while($row = $result->fetch_assoc()): ?>
                        <tr><td><?= $row['id'] ?></td><td><?= $row['name'] ?></td><td><?= $row['phone'] ?></td><td><?= $row['address'] ?></td><td><?= $row['ticket_count'] ?></td></tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
            </div>
