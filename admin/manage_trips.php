    ...
    <head>
        ...
        <title>Quản Lý Chuyến Đi - Đoàn Xuân</title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="content-body">
                <table>
                    <thead>
                        <tr><th>ID</th><th>Nơi Đi</th><th>Nơi Đến</th><th>Thời Gian Khởi Hành</th><th>Thời Gian Đến</th></tr>
                    </thead>
                    <tbody>
                        <?php while($row = $result->fetch_assoc()): ?>
                        <tr><td><?= $row['id'] ?></td><td><?= $row['departure'] ?></td><td><?= $row['destination'] ?></td><td><?= $row['departure_time'] ?></td><td><?= $row['arrival_time'] ?></td></tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
            </div>
